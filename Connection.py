...
class Connection(ConnectionInterface):
    ...
    # get page, links, and title in a tuple from a topic
    ...
    def find_all_connections(self, max_iter=DEFAULT_MAX_ITR):
        ...
        first_parents = self.init_parents(self.first_links, self.first_topic)
        second_parents = self.init_parents(self.second_links, self.second_topic)
